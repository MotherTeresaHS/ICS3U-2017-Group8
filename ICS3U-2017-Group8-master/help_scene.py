...
class HelpScene(Scene):
    def setup(self):
        ...
        self.orange_guy = SpriteNode('./assets/sprites/orange_guy.PNG',
                                       parent = self,
        ...
        self.pink_guy = SpriteNode('./assets/sprites/pink_guy.PNG',
                                       parent = self,
        ...
        self.coin_amount = SpriteNode('./assets/sprites/coin_amount.PNG',
                                       parent = self,
